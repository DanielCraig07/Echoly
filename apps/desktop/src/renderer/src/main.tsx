...
class ErrorBoundary extends Component<{ children: ReactNode }, { error: Error | null }> {
  ...
  render() {
    if (this.state.error) {
      ...
      return (
        <div className="empty-state" style={{ padding: 40, height: '100vh', justifyContent: 'center' }}>
          <h2>应用遇到渲染错误</h2>
          <pre style={{ background: 'rgba(255,255,255,0.05)', padding: 16, borderRadius: 8, fontSize: 12, textAlign: 'left', overflow: 'auto', maxWidth: 600, margin: '16px 0' }}>
