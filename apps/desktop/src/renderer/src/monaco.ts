...
monaco.editor.defineTheme('custom-dark', {
  ...
  colors: {
    ...
    // 覆盖 Monaco 默认深蓝 (#001f4d) Peek View，与 IDE 主题完美融合
    'peekView.border': '#4c8dff',
    'peekViewEditor.background': '#141414',
    'peekViewEditorGutter.background': '#141414',
    'peekViewEditor.matchHighlightBackground': '#4c8dff35',
    'peekViewResult.background': '#181818',
    'peekViewResult.fileForeground': '#e6e8ec',
    'peekViewResult.lineForeground': '#8b8f9c',
    'peekViewResult.matchHighlightBackground': '#4c8dff40',
    'peekViewResult.selectionBackground': '#24324d',
    'peekViewResult.selectionForeground': '#ffffff',
    'peekViewTitle.background': '#181818',
    'peekViewTitleDescription.foreground': '#8b8f9c',
    'peekViewTitleLabel.foreground': '#e6e8ec',
